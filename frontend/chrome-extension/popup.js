...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function loadSettings() {
    chrome.storage.sync.get(['enabled', 'showNotifications', 'autoAnalyze'], function(result) {
      ...
      autoAnalyzeToggle.classList.toggle('active', result.autoAnalyze !== false);
  ...
  function toggleAutoAnalyze() {
    ...
    chrome.storage.sync.set({ autoAnalyze: newState }, function() {
      autoAnalyzeToggle.classList.toggle('active', newState);
    });
  }
  ...
  chrome.storage.sync.get(['enabled', 'autoAnalyze'], function(result) {
    if (result.enabled !== false && result.autoAnalyze !== false) {
      analyzeCurrentPage();
    }
  });
});
